              ...
              <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-1">
                    {getContent("about", "certification_title", "Certificada")}
                  </div>
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                  {getContent("about", "title_part1", "Conheça a")}
                  <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent block">
                    {getContent("about", "title_part2", "Thalita")}
                  </span>
                </h2>
              ...
              <div className="pt-4">
                ...
                >
                  {getContent("about", "cta_text", "Conversar com a Thalita")}
                  <svg
